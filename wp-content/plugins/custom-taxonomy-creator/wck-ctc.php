...
function wck_ctc_add_side_boxes(){
	add_meta_box( 'wck-ctc-side', 'Wordpress Creation Kit Pro', 'wck_ctc_side_box_one', 'wck_page_ctc-page', 'side', 'high' );
	add_meta_box( 'wck-ctc-side-two', 'Wordpress Creation Kit', 'wck_ctc_side_box_two', 'wck_page_ctc-page', 'side', 'high' );
}
