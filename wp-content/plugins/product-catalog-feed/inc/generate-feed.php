...
class WPwoofGenerator{
    ...
    {
        global $woocommerce, $woocommerce_wpwoof_common, $store_info, $wp_query, $wpdb, $post, $_wp_using_ext_object_cache;
           ...
           // $this->_storedebug("FIELDS:");
            ...
            try {
                ...
                if (is_array($products) && count($products)) {
                    ...
                    $this->_wpwoofeed_settings['total_products'] = $total_files < 3? 0 : $total_files -3;
                    wpwoof_update_feed($this->_wpwoofeed_settings, $this->_wpwoofeed_settings['edit_feed'],true);
                }
