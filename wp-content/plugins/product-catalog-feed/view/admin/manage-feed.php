...
?>
    <script>
        function storeWpWoofdata(){
            var data = jQuery('#iDwpwoofGLS').serialize()+"&action=set_wpwoof_global_data&_ajax_nonce="+WPWOOF.nonce;
        ...
        <table class="form-table manage_global_settings_block">
            <tr>
                ...
                <td>
                    ...
                    <select name="wpwoof_schedule" id="wpwoof_schedule" onchange="jQuery.fn.saveWPWoofParam({'action':'set_wpwoof_schedule','wpwoof_schedule':this.value});">
                        <?php 
