...
<div class="wt-sc-tab-content" data-id="<?php echo esc_attr( $target_id ); ?>">
	...
	<?php $wbte_admin_img_path = WT_SMARTCOUPON_MAIN_URL . 'admin/images/'; ?>
	<ul class="wt-smartcoupon-help-links">
		<li>
			<img style="height: 90px;" src="<?php echo esc_url( "{$wbte_admin_img_path}documentation.png" ); ?>">
		...
		<li>
			<img src="<?php echo esc_url( "{$wbte_admin_img_path}support.png" ); ?>">
