						...
						if ( ! $is_trash_segment ) {
							?>
								<div class="wbte_sc_bogo_listing_actions_content">
									<span style="height:24px;" class="wbte_sc_custom_title" onclick="window.location.href = '<?php echo esc_url( admin_url( 'admin.php?page=' . self::$bogo_page_name . '&wbte_bogo_id=' . $coupon_id ) ); ?>'" data-title="<?php esc_attr_e( 'Edit', 'wt-smart-coupons-for-woocommerce' ); ?>"><?php echo wp_kses_post( $wbte_ds_obj->render_html( array( 'html' => '{{wbte-ds-icon-edit}}' ) ) ); ?></span>

									<span class="wbte_sc_bogo_listing_single_duplicate wbte_sc_custom_title" style="height:24px;" data-title="<?php esc_attr_e( 'Duplicate', 'wt-smart-coupons-for-woocommerce' ); ?>"><?php echo wp_kses_post( $wbte_ds_obj->render_html( array( 'html' => '{{wbte-ds-icon-clone}}' ) ) ); ?></span>

									<span class="wbte_sc_bogo_listing_single_delete wbte_sc_custom_title wbte_sc_bogo_hide_xs" style="height:24px;" data-title="<?php esc_attr_e( 'Delete', 'wt-smart-coupons-for-woocommerce' ); ?>"><?php echo wp_kses_post( $wbte_ds_obj->render_html( array( 'html' => '{{wbte-ds-icon-trash}}' ) ) ); ?></span>
