...
$products_additional_class = 'exclude-auto-height list-unstyled';
...
<section class="<?php echo esc_attr( $section_class ); ?>" <?php if ( !empty( $animation ) ) : ?>data-animation="<?php echo esc_attr( $animation );?>"<?php endif; ?>>
    <h2 class="sr-only visually-hidden"><?php echo esc_html__( 'Products Grid', 'electro' ); ?></h2>
    <div class="container">
                    ...
                    while ( $products->have_posts() ) : $products->the_post();
                        ...
                        if ( $products_count == 4 || $products_count == 5 ) {
                            ...
                            if ( $products_count == 4 ) {
                                ...
                                echo '</div><div class="products-1 column"><ul class="products list-unstyled product-main-2-1-2 show-btn">';
                            }
